...
/**
 * AdvServicesDeliveryPoints
 *
 * @ORM\Table(name="adv_services_delivery_points", uniqueConstraints={@ORM\UniqueConstraint(name="code_name", columns={"delivery_id", "code_name"})}, indexes={@ORM\Index(name="index_country_id", columns={"country_id"}), @ORM\Index(name="index_city_id", columns={"city_id"}), @ORM\Index(name="index_delivery_zone", columns={"delivery_zone"}), @ORM\Index(name="index_delivery_id", columns={"delivery_id"})})
 * @ORM\Entity
 */
class AdvServicesDeliveryPoints
{
    /**
     * @var int
     *
