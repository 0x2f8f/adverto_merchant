...
use App\Core\Entity\AdvServicesPickup;
use Doctrine\ORM\Mapping as ORM;

/**
 * UserServicesPickup
 *
 * @ORM\Table(name="adv_user_services_pickup", indexes={@ORM\Index(name="index_pickup_id", columns={"pickup_id"}), @ORM\Index(name="index_user_hash", columns={"user_hash"})})
 * @ORM\Entity
 */
class UserServicesPickup
{
    /**
     * @var int
     *
     ...
     *
     * @ORM\ManyToOne(targetEntity="App\Core\Entity\AdvServicesPickup")
     * @ORM\JoinColumns({
